...
@section('content')
    ...
    <section class="content container-fluid">
        <form method="POST" action="{{ route('drug.editsave', ['id' => $drug->id]) }}">
        @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="drugname" class="form-control" id="inputEmail3" value=" {{ $drug->name }} " >
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-4 control-label">จำนวน</label>
                            <input type="text" name ="drugqty" class="form-control" id="inputEmail3"  value=" {{ $drug->qty }} " >
                        </div>
                    </div>
                </div>
            </div>
